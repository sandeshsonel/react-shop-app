...
import { addSavedItem } from "../../../app/actions";

const ProductList = ({ products, addSavedItem }) => {
          ...
          <div className="cursor-pointer hover:opacity-75 w-auto h-auto">
            <div className="relative">
              <img
                ...
                alt=""
              />
              <div className="absolute cursor-pointer bottom-0 right-0 mr-2 mb-2 bg-white bg-opacity-70 px-1 py-1 rounded-full">
                <svg onClick={() => addSavedItem(product)} xmlns="http://www.w3.org/2000/svg" className="w-6" viewBox="0 0 512 512">
                  <path
