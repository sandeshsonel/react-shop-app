...
const SignInAndSignUpPage = ({ setUserData, handleClose }) => {
  ...
  const onSubmit = (e) => {
    ...
    var dateOfBirth = new Date(userDetails.dateOfBirth.year, userDetails.dateOfBirth.month, userDetails.dateOfBirth.date, 0, 0, 0, 0);

    let formData = new FormData();

    formData.append("email", userDetails.emailAddress);
    ...
    formData.append("mostlyInterestedIn", userDetails.mostlyInterestedIn);

    axios.post("http://localhost:8000/api/v1/users/signup", userDetails.emailAddress);

    console.log("xoxo", formData);
  };
