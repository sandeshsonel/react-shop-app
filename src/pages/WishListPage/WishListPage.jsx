      ...
      <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)" }} className="">
        <div className="flex flex-col flex-nowrap justify-between text-center">
          ...
          <div className="mt-4">
            ...
            <p className="text-sm mt-4">Sign in to sync your Saved Items across all your devices.</p>
            <button className="bg-black shadow-lg font-bold uppercase py-2 mt-6 text-sm text-white w-full">Sign In</button>
          </div>
        </div>
      </div>
      <div>
