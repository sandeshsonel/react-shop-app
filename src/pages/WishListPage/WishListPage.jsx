        ...
        <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)" }} className="max-w-xs">
          {isLogin ? (
            <div className="flex flex-col flex-nowrap justify-between text-center">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="m-auto w-8" viewBox="0 0 512 512">
                  <path
              ...
              <div className="mt-4">
                ...
                <Link to="/">
                  <button className="bg-black shadow-lg font-bold uppercase py-3 mt-6 text-sm text-white w-full">Start Shopping</button>
                </Link>
              </div>
            </div>
          ) : (
